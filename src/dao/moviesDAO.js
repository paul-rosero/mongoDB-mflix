...
export default class MoviesDAO {
  ...
  static async getMoviesByCountry(countries) {
    ...
    */
    ...
    try {
      ...
      // wire.
      // I added what is in between the (). Saying find countries and project the _id(implied) and the title(by typing 1).
  ...
  static genreSearchQuery(genre) {
    ...
    */
    ...
    // I added what is in between the main {}. genres: is what is the name used in the database, not genre.
  ...
  static async facetedSearch({
    ...
    */
    ...
    const queryPipeline = [
      ...
      // The code for these are const are above
      skipStage,
      limitStage,
      facetStage
    ]
    ...
    try {
      ...
      */
      ...
      const pipeline = [
        ...
        }, //added from here to the end to pass this test.
          {$lookup: {
            from: "comments",
            let: { 'id': '$_id' },
            pipeline: [
      ...
      */
      if (e === e) {
        return null
      } // added this condition to see if the error equals error to return null.
