  ...
  */
  ...
  static async addComment(movieId, user, comment, date) {
    try {
      ...
      const commentDoc = { 
        //add coded between these brackets to pass test.
    ...
    */
    ...
    try {
      ...
      const deleteResponse = await comments.deleteOne({
        ...
        email: userEmail //add this code to pass the test. 
      })
  ...
  static async mostActiveCommenters() {
    ...
    */
    try {
      ...
      // const pipeline = []  this was here originally.
      
      //wrote this to pass the Ticket: User Report 
      const pipeline = [
